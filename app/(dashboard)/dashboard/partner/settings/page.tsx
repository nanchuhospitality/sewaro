...
export default async function PartnerSettingsPage() {
  ...
  const withPartner = await supabase
    .from('businesses')
    .select('name,enable_nova_delivers_menu,enable_nova_delivers_ordering,nova_delivers_commission_percent,nova_delivers_delivery_charge_npr,nova_delivers_support_phone')
  ...
  if (
    ...
    if (fallback.data) {
      ...
      schemaNotice =
        'Nova partner fields are not available yet. Run migrations 0016_add_business_enable_nova_delivers_menu.sql, 0017_add_nova_delivers_partner_fields.sql, 0019_add_business_enable_nova_delivers_ordering.sql, and 0020_add_business_nova_delivers_support_phone.sql.'
    }
  }
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
      <h1 className="text-xl font-semibold">Nova Delivers Settings</h1>
